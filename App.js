    ...
    return (
        <Tab.Navigator initialRouteName="Training" screenOptions={{ headerShown: false }}>
            <Tab.Screen name="Training" component={Training}
               options={({navigation}) => (
                {
                    tabBarIcon: ({ color, sizem, focused }) => (<Entypo name="home" size={24} color={focused ? "#1DB954" : "#666"} />),
            ...
            <Tab.Screen name="Vocabulary" component={Vocabulary}
                options={({navigation}) => (
                    {
                        tabBarIcon: ({ color, sizem, focused }) => (<MaterialIcons name="translate" size={24} color={focused ? "#1DB954" : "#666"} />),
